...
<body>
    <div class="container">
        ...
        <img src="{{ asset('assets/icon/403.svg') }}" alt="403 Akses ditolak Illustration">

        <h1>Akses Halaman Ditolak!</h1>
        <p>Yah, kamu tidak di perbolehkan mengakses halaman ini, akses di tolak server.</p>
